...
//         if (workspace && workspace !== 'All') {
//             filtered = filtered.filter(
//                 (job) => job.workspace.toLowerCase() === workspace.toLowerCase()
//             );
//         }
...
//             <main className="min-h-screen pt-24 bg-[#f9f9f9] text-gray-900 px-4">
//                 <section className="max-w-6xl mx-auto py-10">
//                     <h1 className="text-3xl md:text-4xl font-semibold text-center text-[#2C1A47] mb-10">
//                         Career Opportunities
//                     </h1>

//                     {/* Filters */}
//                     <div className="flex flex-wrap md:flex-nowrap justify-center items-end gap-6 mb-10">
//                         <div className="flex flex-col">
//                             <label className="text-sm font-semibold mb-1">Job Type</label>
//                             <select
//                                 value={jobType}
...
//                         <button
//                             onClick={handleSearch}
//                             className="px-6 py-2 bg-[#2C1A47] text-white font-medium hover:bg-[#1e1132] transition rounded-md"
//                         >
//                             Search Jobs
//                         </button>
//                     </div>
...
//                     {/* Job Count */}
//                     <div className=" max-w-[65vw] mx-auto text-sm font-semibold text-left mb-6">
